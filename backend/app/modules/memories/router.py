...
async def list_farm_memories(
    ...
    return await service.list_farm(farmer_id, farm_id)
...
async def list_plot_memories(
    ...
    return await service.list_plot(farmer_id, plot_id)
...
@router.delete(
    "/chats/{chat_id}/memory-connection", status_code=status.HTTP_204_NO_CONTENT
)
async def disconnect_general_chat(
